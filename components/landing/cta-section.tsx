      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full text-sm mb-8">
            ...
            <p className="text-sm text-white/80 mb-12 max-w-xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="px-4 py-1 text-xs md:text-sm rounded-full font-semibold bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105 group"
                asChild
              >
                <Link href="/signup">
                  Start Creating
              ...
              <Button
                variant="ghost"
                size="lg"
                className="px-4 py-1 text-xs md:text-sm rounded-full font-semibold text-white bg-white/10 transition-all duration-300"
                asChild
              >
